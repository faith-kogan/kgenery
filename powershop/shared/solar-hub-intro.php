<?php
/**
 * The page intro for all Solar hub related pages
 *
    ...
    <div class="o-layout">
      <div class="o-layout__item">
        ...
        <header class="c-article-intro">
          <?php if (is_post_type_archive('solar')) : ?>
            <h2 class="u-font-h2  c-article-intro__title e-colour--grey-dark">Solar hub</h2>
          <?php else : ?>
            <h1 class="u-font-h2  c-article-intro__title e-colour--grey-dark">Solar hub</h1>
          <?php endif; ?>
          <p class="u-font-p1"><?php the_field('solar_intro_text', 'option'); ?></p>
            ...
            <div class="c-input">
              ...
              <div class="c-input__button-inside">
                <div>
                  ...
                  />
                  <input type="hidden" name="ps_post_type" id="ps_post_type" value="solar" />
                  <button type="submit">
