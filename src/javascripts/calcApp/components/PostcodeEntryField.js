...
class PostcodeEntryField extends Component {
  ...
  validatePostcode = postcode => {
    ...
    if (required && postcode.length === 0) {
      ...
      this.handleError( <Fragment>Sorry, we don&apos;t currently service the postcode you entered. <br />For more details, visit <a href="https://www.koganenergy.com.au/faq-join/" target="_blank" rel="nofollow noopener">our FAQ</a>.</Fragment>, true);
    } else {
      this.handleError("");
    }
  };
